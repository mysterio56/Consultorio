...
<?php if(in_array($permisos,$aPermisos['Agregar']) ): ?>
		<a id="agregar" class="abutton" onclick = "$('.screenLoad').show();" href="<?= base_url('service/agregar') ?>">Agregar</a>
	<?php endif; ?>
		<a id="busavan" class="abutton"  onclick = "$('.screenLoad').show();" href="<?= base_url('service/buscar') ?>">Búsqueda Avanzada</a>
		<a id="cancela" display:none  onclick = "$('.screenLoad').show();" href="<?= base_url('service') ?>" class="abutton">Cancelar</a>
